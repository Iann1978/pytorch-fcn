...
class Model(nn.Module):
    def __init__(self, cfg='fcn8s.yaml', ch=3, nc=None):  # model, input channels, number of classes
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='models/fcn8s.yaml', help='model.yaml')
